...
public class TakingTurnsQueueTests {
    ...
    // Defect(s) Found: People are being added to the front of the Queue instead of the back
    public void TestTakingTurnsQueue_FiniteRepetition() {
        ...
        while (players.Length > 0) {
            if (i >= expectedResult.Length) Assert.Fail("Queue should have ran out of items by now.");
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: It's not re-adding people who should have infinite turns
